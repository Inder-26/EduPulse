...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            logging.info(f"Exporting data from MongoDB: {database_name}.{collection_name}")
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame):
        """
        Save raw data to artifacts/data_ingestion/feature_store
        """
        try:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            logging.info(f"Data Ingestion Check: {data_ingestion_artifact}")
